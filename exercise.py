...
def check_letter():
    ...
    if char.isalpha() and len(char) == 1:
        ...
        print("Invalid entry. Please enter a letter (a-z or A-Z).")
...
def determine_season():
    ...
    if not month.isalpha() and not len(month) == 3:
        print("Invalid entry.")
        return
    ...
    seasons = {
        "winter": [("dec", 21, 31), ("jan", 1 , 31), ("feb", 1, 31), ("mar", 1, 19)],
        "spring": [("mar", 20, 31), ("apr", 1, 31), ("may", 1, 31), ("jun", 1, 20)],
        "summer": [("jun", 21, 31), ("jul", 1, 31), ("aug", 1, 31), ("sep", 1, 21)],
        "fall": [("sep", 22, 31), ("oct", 1, 31), ("nov", 1, 31), ("dec", 1, 20)]
    }
    
    
    for season, dates in seasons.items():
        for date in dates:
            if month == date[0] and day >= date[1] and day <= date[2]:
                print(f"{month.capitalize()} {day} is in {season.capitalize()}.")
                return
    print("Invalid entry.")
